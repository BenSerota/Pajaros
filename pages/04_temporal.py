...
# =============================================================================
# SECCION 1: Tendencia Anual (full-width chart, stat badge below)
# =============================================================================
...
# Linea de tendencia de pendiente de Sen
...
# =============================================================================
# SECCION 2: Estacionalidad Mensual (full-width polar + stat badge below)
# =============================================================================
...
# Rayleigh test badge BELOW chart
angles_list = []
...
# =============================================================================
# SECCION 3: Mapa de Calor Ano x Mes (full-width, 500px)
# =============================================================================
...
# =============================================================================
# SECCION 4: Curvas Acumulativas por Ano (full-width)
# =============================================================================
...
# =============================================================================
# SECCION 5: Cronologia del Esfuerzo de Muestreo (full-width)
# =============================================================================
...
# =============================================================================
# SECCION 6: Estacionalidad: Nocturnas vs Diurnas (full-width + badge below)
# =============================================================================
...
if not has_activity:
    ...
    if len(df_nd) == 0:
        ...
        # Sombreado de temporada de cria de pardelas
        fig_nd.add_vrect(
            x0=2.5, x1=10.5,
        ...
        # Tabla de desglose mensual (full-width, no expander)
        st.divider()
        st.markdown("**Tabla de desglose mensual**")
